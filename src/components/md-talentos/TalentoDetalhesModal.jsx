// src/components/md-talentos/TalentoDetalhes.jsx

const TalentoDetalhesModal = ({ talento, onClose }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex justify-center items-center z-50 p-4">
      <div className="container mx-auto p-0 lg:p-6 bg-gray-50 max-h-[90vh] overflow-y-auto rounded-2xl">
