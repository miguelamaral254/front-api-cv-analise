...
import { MdWork, MdSchool, MdLanguage, MdQuestionAnswer, MdArrowBack, MdContentCopy, MdMailOutline, MdOutlineBookmarks, MdLocationOn, MdCalendarToday, MdFlag } from 'react-icons/md';
  ...
  return (
    <div className="bg-white shadow-xl rounded-2xl p-6 md:p-10 max-w-7xl w-full mx-auto animate-fade-in">
      ...
      <div className="flex justify-between items-start mb-6 border-b pb-4">
        ...
        <button onClick={onVoltarClick} className="flex items-center gap-2 bg-gray-100 text-gray-600 px-6 py-2 rounded-lg hover:bg-gray-200 transition-colors duration-200 font-medium flex-shrink-0">
          <MdArrowBack /> Voltar
        </button>
      </div>
