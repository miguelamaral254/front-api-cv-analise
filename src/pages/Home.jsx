...
const IconInovacao = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-icons_primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" /></svg>;
const IconColaboracao = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-icons_primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>;
const IconCrescimento = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-icons_primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg>;
        ...
        <div className="bg-white text-gray-800">
            ...
            <section className="bg-gradient-to-b from-blue-800 to-blue-900 text-white">
                <div className="container mx-auto px-6 py-24 text-center">
                    ...
                    <div className="mt-8">
                        <Link
                            to="/vagas"
                            className="bg-icons_primary hover:bg-orange-500 text-white font-bold py-3 px-8 rounded-full text-lg transition-all duration-300 ease-in-out transform hover:scale-105">
                            Vagas abertas
                        </Link>
                    </div>
                </div>
            ...
            <section className="container mx-auto px-6 py-20">
                <div className="text-center max-w-4xl mx-auto space-y-6">
                    ...
                    <p className="text-lg text-gray-600">
                        A Cognvox é formada por profissionais das áreas da psicologia, da educação e da ciência da computação. Estudamos e desenvolvemos tecnologias e serviços voltados para pessoas neurodivergentes, a partir de uma perspectiva histórico-cultural.
                    </p>
                    <div className="py-4">
                    ...
                    <p className="text-lg text-gray-600">
                        Acreditamos que, por meio da intervenção do outro (professores, pais e psicólogos), é possível superar limitações e transformar desafios em potencialidades. Nossa missão é clara: quebrar barreiras e construir um futuro mais inclusivo.
                    </p>
                </div>
            </section>
            ...
            <section className="container mx-auto px-6 py-20">
                ...
                <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-icons_primary/20  border-l-4 border-icons_primary p-6 rounded-r-lg">
                        <h3 className="text-xl font-bold text-icons_primary">Paixão por Inovação</h3>
                        <p className="mt-1 text-gray-700">Buscamos sempre novas formas de promover inclusão e desenvolvimento.</p>
                    </div>
                    <div className="bg-icons_primary/20  border-l-4 border-icons_primary p-6 rounded-r-lg">
                        <h3 className="text-xl font-bold text-icons_primary">Pessoas em Primeiro Lugar</h3>
                        <p className="mt-1 text-gray-700">Cuidamos da nossa equipe, dos clientes e da comunidade com empatia e respeito.</p>
                    </div>
                    <div className="bg-icons_primary/20 border-l-4 border-icons_primary p-6 rounded-r-lg">
                        <h3 className="text-xl font-bold text-icons_primary">Integridade Absoluta</h3>
                        <p className="mt-1 text-gray-700">Agimos com transparência e ética em tudo o que fazemos.</p>
                    </div>
                    <div className="bg-icons_primary/20  border-l-4 border-icons_primary p-6 rounded-r-lg">
                        <h3 className="text-xl font-bold text-icons_primary">Compromisso com o Impacto</h3>
            ...
            <section className="bg-blue-800 text-white">
                <div className="container mx-auto px-6 py-20 text-center">
                    ...
                    <div className="mt-8">
                        <Link
                            to="/vagas"
                            className="bg-icons_primary hover:bg-orange-500 text-white font-bold py-3 px-8 rounded-full text-lg transition-colors"
                        >
                            Junte-se ao Time
                        </Link>
                    </div>
